...
// Se activa SOLO si EMAIL_TEST_MODE=true está definido explícitamente
// (por defecto apagado, para no romper el envío real en producción).
// ============================================================
const EMAIL_TEST_MODE = process.env.EMAIL_TEST_MODE === "true";
const TEST_EMAIL = process.env.EMAIL_TEST_ADDRESS || "jcurruchiche@cna.gob.gt";
